...
<div class="card">
    ...
    <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap; margin: 2rem 0;">
        <a href="/labs6/index.php?action=generate&format=csv" class="btn btn-success">📊 Скачать CSV</a>
        <a href="/labs6/index.php?action=generate&format=excel" class="btn" style="background: linear-gradient(135deg, #2196F3, #1976D2);">📈 Скачать Excel</a>
        <a href="/labs6/index.php?action=generate&format=pdf" class="btn btn-danger">📄 Скачать PDF</a>
    </div>
</div>
